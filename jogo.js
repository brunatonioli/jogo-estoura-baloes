...
function game_over(qtde_baloes){
	alert("fim de jogo, você não conseguiu estourar toos os balões a tempo")
}situacao_jogo:
...
function pontuacao(acao){
 ...
 function remove_eventos_baloes(){
 	...
 	//percoree o elemento de acordo com o id e só irá sair do laço
 	while(document.getElementById('b'+i)) {
 		//retira o evento onclivk do elemento
 		document.getElementById('b'+i).onclick = '';
 		i++;//Faz a interação d variavel i
 	}
 }